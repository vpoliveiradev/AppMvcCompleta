...
{
    //Valida a moeda baseada na cultura brasileiro no server
    ...
    //Valida a moeda baseada na cultura brasileiro no client
    ...
    //Para funcionar o Moeda attribute no client (Javascript) é necessário ter um provider
